...
enum type_of_lex {
	...
	LEX_NOT, LEX_OR, LEX_PROGRAM, LEX_READ, LEX_THEN, LEX_TRUE, LEX_VAR, LEX_WHILE, LEX_WRITE, LEX_REPEAT, LEX_UNTIL,  /*18+2*/
	LEX_FIN,
	/*19+2*/
	LEX_SEMICOLON, LEX_COMMA, LEX_COLON, LEX_ASSIGN, LEX_LPAREN, LEX_RPAREN, LEX_EQ, LEX_LSS,   /*27+2*/
	LEX_GTR, LEX_PLUS, LEX_MINUS, LEX_TIMES, LEX_SLASH, LEX_LEQ, LEX_NEQ, LEX_GEQ,              /*35+2*/
	LEX_NUM,                                                                                    /*36+2*/
	LEX_ID,                                                                                     /*37+2*/
	POLIZ_LABEL,                                                                                /*38+2*/
	POLIZ_ADDRESS,                                                                              /*39+2*/
